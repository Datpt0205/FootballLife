...
import LakeBackground from "../../images/lake-background.jpg";
import Astronaut from "../../images/not-found.svg";
import SearchPlace from "../../images/search.svg";
      ...
      <div className="container-weather">
        ...
        <div className="content-weather">
          ...
          >
            ...
            <div className="search-city">
              <h2
                style={{
                  marginRight:
                    currentLanguage === "es" || "fr" ? "10px" : "0px",
                }}
              >
                {t("title")}
              </h2>
          ...
          <div className="info-container">
             <FontAwesomeIcon icon={faClose}  style = {{width: 20, height: 20, marginLeft: 430}} onClick = {handleClose}/>
                    ...
                    {noData === "Location Not Found" ? (
                      ...
                      <>
                        ...
                        <p style={{ padding: "20px" }}>
                          Don't worry, if you don't know what to search for,
                          try: Hanoi, Ho Chi Minh, London or maybe Turan.
                        </p>
                      </>
                    )}
                  </div>
