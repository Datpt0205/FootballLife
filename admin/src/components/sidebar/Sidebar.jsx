    ...
    <div className="sidebar">
      <div className="top">
        <Link to="/" style={{ textDecoration: "none" }}>
          <span className="logo"><svg width="32" height="32" xmlns="http://www.w3.org/2000/svg">
            <path
      ...
      <div className="center">
        <ul>
          ...
          <Link to="/pitchCenters" style={{ textDecoration: "none" }}>
            <li>
              <StoreIcon className="icon" />
              <span>Pitch Centers</span>
            </li>
          </Link>
          <Link to="/pitches" style={{ textDecoration: "none" }}>
          <li>
